...
# this was changed to do 3x SR intead of 4x SR
class Generator(nn.Module):
  def __init__(self, in_channels, features):
    ...
    self.mid_layer = nn.Sequential(
      nn.Conv2d(features, features*9, 3, 1, 1),
        nn.PReLU(),
    )
    self.PS = PixelShuffle(features*9, features*9,3) # this was changed from 2 PS layers to 1
